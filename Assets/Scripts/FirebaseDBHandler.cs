...
public static class FirebaseDBHandler
{
    ...
    public static Firebase.Storage.StorageReference profilepic_storage_ref = yipliStorage.GetReferenceFromUrl("gs://yipli-test-project.appspot.com/profile-pics/");

    private static string profilePicRootUrl = "gs://yipli-test-project.appspot.com/profile-pics/";

    static Firebase.Auth.FirebaseAuth auth = Firebase.Auth.FirebaseAuth.DefaultInstance;
    private const string projectId = "yipli-test-project"; //Taken from Firebase project settings
    //private static readonly string databaseURL = "https://yipli-project.firebaseio.com/"; // Taken from Firebase project settings

    private static readonly string storagePath = "gs://yipli-test-project.appspot.com/game-setups/";
